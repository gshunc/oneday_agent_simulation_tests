...
async def run_oneday_scenario(test_scenario: Scenario, testrun_uid: str, model_id: str, diagnosis_only: bool = False, use_turn: bool = False, turn_uuid: str | None = None, request=None):
    ...
    nurse_description = (
        ...
        "## How to behave\n\n"
        "- Your first message MUST be exactly 'Hello' — nothing else.\n"
        "- After the agent greets you, briefly mention the patient's main complaint (e.g. 'I have a "
        "4-year-old boy with diarrhea' or 'I'm seeing a man with chest pain'). Keep it to one or two "
        "sentences — like a real WhatsApp message.\n"
        "- Let the agent lead. Wait for it to ask questions, then answer them. Don't volunteer extra "
        "information the agent hasn't asked about yet.\n"
