...
async def run_oneday_scenario(test_scenario: Scenario, testrun_uid: str, model_id: str, diagnosis_only: bool = False, use_turn: bool = False, turn_uuid: str | None = None, request=None):
    ...
    nurse_description = (
        ...
        "Turn 2 (after the agent greets you): Give the patient's age and main symptom only. "
        "One short sentence, e.g. 'I have a 4-year-old boy with diarrhea'. "
        "No vitals, no test results, no negatives, no extra details.\n\n"
