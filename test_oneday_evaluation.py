...
async def run_oneday_scenario(test_scenario: Scenario, testrun_uid: str, model_id: str, diagnosis_only: bool = False, use_turn: bool = False, turn_uuid: str | None = None, request=None):
    ...
    nurse_description = (
        ...
        "3. **Follow the script**: Use the scenario details as your source of truth. Answer whatever "
        ...
        "If the agent asks about something not covered in the scenario, say that it's unavailable and "
        "can't be tested for, and ask the agent to move on.\n\n"
