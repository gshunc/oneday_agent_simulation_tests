...
def oneday_judge_prompt(scenario_description: str, criteria: list[str]) -> str:
    ...
    return f"""
      ...
      - A diagnosis should be a committed statement. The agent should outright declare the diagnosis using a clear diagnostic frame such as "The diagnosis is X", "Diagnosis: X", "Based on the symptoms, the diagnosis is X", or "This sounds like X".
